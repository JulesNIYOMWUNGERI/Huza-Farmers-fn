...
import { updateStart, updateSuccess, updateError, clearError, clearSuccessCondition } from "../slices/customerSlice";
...
export const signUp = async (customerData,dispatch,setCustomerData) => {
...
export const signIn = async (customerData,dispatch,setCustomerData,navigate) => {
    const loginData = {
